...
<body class="materialdesign">
    <div class="wrapper-pro">
        ...
        <div class="content-inner-all">
            ...
            <?php include('../../Include/header_employee.php'); ?>    
            ...
            <header>
				...
				<a href="../PredictLaborCost/PredictLaborCost.php">
					<button class="button-64" role="button">
						<span class="text">view Payslip</span>
					</button>
				</a>
            ...
            <main>
                ...
                <section class="top-todos">
                    <h2> Leave Managing</h2>
                   <div class="payroll-actions">
                        <button>Apply Leave</button>
                        <button>Cancel Leave</button>
                        <button>View Balance Leave</button>
                    </div>
                </section>
                <section class="grow-your-business">
                    <h2>Update Personal Information</h2>
                    <ul>
                        <li><span style="color:red;">Name</span></li>
                        <li><span style="color:red;">Addres</span></li>
                        <li><span style="color:red;">Contact Details</span></li>
                        <li><span style="color:red;">Email</span></li>
                    </ul>
                </section>
