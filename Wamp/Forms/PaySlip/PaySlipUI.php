                            ...
                            <div class="sparkline8-list shadow-reset">
                                ...
                                <div id="calculateAttendanceProcess"></div>
									<div class="sparkline8-graph">
										<form id="form1" name="form1" method="post" autocomplete="off" action="PaySlip.php">
											<div class="row">
												<div class="col-md-3">	
													<div class="form-group">
														<label for="txtDepartment" style="text-align: left; display: block;">Select Department</label>
														<select class="form-control" id="cmbDepartment" name="cmbDepartment">
														...
														<input type="text" id="HiddenValue" name="HiddenValue" value="1" hidden />
													</div>
												</div>
												<div class="form-group" style="text-align: left; display: block;"><br>
													<button type="submit" class="btn btn-primary" id="PaySlipGenerate" style="background-color:#802000;">Generate Pay Slip</button>
												</div>
											</div>
										</form>
									</div><br>
