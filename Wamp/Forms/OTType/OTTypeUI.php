                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">OT Type</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="sparkline8-list shadow-reset">
                                ...
                                <div class="sparkline8-graph">
                                    <form id="otTypeForm" name="otTypeForm" method="post" autocomplete="off" action="">
                                        <div class="container">
                                            <div class="form-group">
                                                <label for="description">OT Type Name</label>
                                                <input type="text" class="form-control" id="description" name="description" maxlength="20" required>
                                            </div>
											<div class="form-group">
                                                <label for="description">OT Rate</label>
                                                <input type="text" class="form-control" id="OTRate" name="OTRate" maxlength="20" required>
                                            </div>
                                            <div class="form-group">
                                                <button type="button" class="btn btn-primary" id="addOTType">Add</button>
                                            </div>
                                        </div>
                                    ...
                                    <div id="otTypeList">
                                        <table class="table table-bordered">
                                            <thead>
                                                <tr>
                                                    <th style="text-align:center;">OT Type Name</th>
                                            ...
                                            if (!empty($resultA)) {
                                                foreach ($resultA as $r) {
                                                    ...
                                                    ?>
                                                    <tr id="show">
                                                        <td style="text-align:left;" id="Description-<?php echo $ID; ?>"><?php echo $r['Description']; ?></td>
                                                        <td style="text-align:left;" id="Description-<?php echo $ID; ?>"><?php echo $r['Rate']; ?></td>
...
<script type="text/javascript">
    $(function() {
        $("#addOTType").click(function() {
            ...
            if (description == '') {
                $(".alertWarning").fadeIn(100).html(' <span class="closebtn" onclick="this.parentElement.style.display=\'none\';\"></span>Description is required!');
                $(".alertWarning").fadeIn().delay(2000).fadeOut();
            } else {
                $.ajax({
                    type: "POST",
                    url: "OTTypeProcess.php",
                    data: dataString,
                    cache: false,
                    success: function(html) {
                        $("#otTypeList").html(html);
                        $("#otTypeForm")[0].reset();
