                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                         <div class="menu-container">
											<a href="../OT/OT_UI.php" class="btn btn-primary">OT Management</a>
										</div>
										<div class="menu-container">
											
											<a href="../OTType/OTTypeUI.php" class="btn btn-primary">OT Type </a>
										</div>
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">OT Form</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="sparkline8-list shadow-reset">
                                ...
                                <div class="sparkline8-graph">
                                    <form id="otForm" name="otForm" method="post" autocomplete="off" action="">
                                        <div class="container">
                                            ...
                                            <div class="form-group">
                                                <label for="otTypeID">OT Type</label>
                                                <select class="form-control" id="otTypeID" name="otTypeID">
                                                    <option value="">Select OT Type</option>
                                                    <?php 
                                                    $query = "SELECT * FROM `ottype` ORDER BY OTTypeID";
                                                    $result = $db_handle->runQuery($query);
                                                    foreach ($result as $row) {
                                                        echo '<option value="'.$row["OTTypeID"].'">'.$row["Description"].'</option>';
                                                    }
                                                    ?>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="otHours" name="otHours" required>
                                            </div>
                                            <div class="form-group">
                                                <button type="button" class="btn btn-primary" id="addOT">Add</button>
                                            </div>
                                        </div>
                                    ...
                                    <div id="otList">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                            <?php
                                            $queryA = "SELECT o.*, e.FirstName,e.EmployeeCode, e.LastName, ot.Description FROM `ot` o 
                                            ...
                                            if (!empty($resultA)) {
                                                foreach ($resultA as $r) {
                                                    ...
                                                    <tr id="show">
                                                        ...
                                                        <td style="text-align:left;" id="ID-<?php echo $ID; ?>"><?php echo $r['FirstName'].' '.$r['LastName']; ?></td>
                                                        <td style="text-align:left;" id="OTTypeID-<?php echo $ID; ?>"><?php echo $r['Description']; ?></td>
                                                        <td style="text-align:left;" id="Month-<?php echo $ID; ?>"><?php echo $r['Month']; ?></td>
                                                        <td style="text-align:left;" id="OTHours-<?php echo $ID; ?>"><?php echo $r['OTHours']; ?></td>
...
<script type="text/javascript">
    $(function() {
        $("#addOT").click(function() {
            ...
            var otTypeID = $("#otTypeID").val();
            var month = $("#month").val();
            var otHours = $("#otHours").val();
            var dataString = 'employeeID=' + employeeID + '&otTypeID=' + otTypeID + '&month=' + month + '&otHours=' + otHours;

            if (employeeID == '' || otTypeID == '' || month == '' || otHours == '') {
