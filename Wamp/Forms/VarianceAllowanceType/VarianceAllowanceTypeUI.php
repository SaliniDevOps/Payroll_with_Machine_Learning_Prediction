...
<head>
    ...
    <title>Variance Allowance Type</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Variance Allowance Type</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="sparkline8-list shadow-reset">
                                ...
                                <div class="sparkline8-graph">
                                    <form id="varianceAllowanceForm" name="varianceAllowanceForm" method="post" autocomplete="off" action="">
                                        <div class="container">
                                    ...
                                    <div id="allowanceList">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                            <?php
                                            $queryA = "SELECT * FROM `varianceallowancetype` ORDER BY `ID` ASC";
    ...
    $(function() {
        $("#addAllowance").click(function() {
            ...
            if (allowanceDescription == '') {
                ...
                $.ajax({
                    type: "POST",
                    url: "VarianceAllowanceTypeProcess.php",
                    data: dataString,
                    cache: false,
                    success: function(html) {
                        $("#allowanceList").html(html);
                        $("#varianceAllowanceForm")[0].reset();
