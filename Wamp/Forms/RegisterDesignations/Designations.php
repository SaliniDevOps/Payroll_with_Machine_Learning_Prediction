                                ...
                                <div class="menu-container">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Designations</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
										...
										<div class="row">
											<div class="col-md-5">
												<div class="form-group">
													<label for="txtDesignations" style="text-align: left; display: block;" >Enter Designation</label>
													<input type="text" class="form-control" id="txtDesignations">
