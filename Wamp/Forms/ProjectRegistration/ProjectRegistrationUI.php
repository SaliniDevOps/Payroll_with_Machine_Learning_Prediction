...
<head>
	...
	include('ProjectRegistrationAjax.php');
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Project Registration</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="sparkline8-list shadow-reset">
                                ...
                                <div class="sparkline8-graph">
                                    <form id="projectForm" name="projectForm" method="post" autocomplete="off" action="">
                                        <div class="container">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="projectManager" name="projectManager"	>
													...
													foreach ($result as $rowDep1) {
														?>
														<option value="<?php echo $rowDep1["EmployeeID"];?>"><?php echo $rowDep1["FirstName"].' '.' '.$rowDep1["LastName"];?></option>
														<?php		
													}
													?>
												</select>
