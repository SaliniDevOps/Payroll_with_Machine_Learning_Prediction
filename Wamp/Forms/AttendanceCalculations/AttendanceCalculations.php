...
<head>
    ...
    <title>Calculate the Attendance</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>

	<?php include('../../Include/headerlinks.php');  
	include('AttendanceCalculationsAjax.php');
	?>
                                ...
                                <div class="row">
                                    ...
                                    <!--div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Calculate the Attendance</span>
                                            </li>
                                        </ul>
                                    </div-->
                                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="sparkline8-list shadow-reset">
								...
								<div class="form-group" style="text-align: left; display: block;"><br>
									<button type="button" class="calculateAttendance btn btn-primary" id="calculateAttendance" style="background-color:#802000;">Calculate the Attendance</button>
									<button type="button" class="ResetBtn btn btn-primary" id="ResetBtn" style="background-color:#b32d00;">Reset</button>
								</div>
                                ...
                                <div class="sparkline8-graph">
									<form id="form1" name="form1" method="post" autocomplete="off" action="">
										<div class="row">
											...
											<div class="form-group" style="text-align: left; display: block;"><br>
												<button type="button" class="calculateAttendance btn btn-primary" id="calculateAttendance">Show</button>
											</div>
										...
										<div id="Insert_Department" >
											<table class="table table-bordered" >
												...
												<?php
												  ...
												  $queryA = "SELECT `rowdatamonthend`.`OT`,`rowdatamonthend`.`Late`,`rowdatamonthend`.`WorkinDay`,`rowdatamonthend`.`WorkingHours`,
															`employee`.`FirstName`,`employee`.`EmployeeCode`,`departments`.`Departments`,`rowdatamonthend`.`ID`,`employee`.`LastName`
															   FROM `rowdatamonthend`
															   INNER JOIN employee ON employee.EmployeeID = rowdatamonthend.EmployeeID
												...
												if(!empty($resultA)){
													foreach ($resultA as $r) {
														...
														<tr id="show">
															...
															<td style ="text-align:left;" id="Departments-<?php echo $ID; ?>"><?php echo $r['WorkinDay']; ?></td>
															<td style ="text-align:left;" id="Departments-<?php echo $ID; ?>"><?php echo $r['OT']; ?></td>
