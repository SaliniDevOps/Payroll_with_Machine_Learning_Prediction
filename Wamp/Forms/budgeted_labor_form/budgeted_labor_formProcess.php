...
if(isset($_POST["Insert_ProjectID"]))
	{
	    //Get variable
		$ProjectID=$_POST["Insert_ProjectID"];
		$budgetedCost=$_POST["budgetedCost"];
		...
		if (empty($HiddenID)) {
			...
			// }else{
				...
				$result = $db_handle->insertQuery("INSERT INTO `budgeted_labor_costs` (`ProjectID`,`BudgetedCost`,`Date`) 
				Values('$ProjectID','$budgetedCost','$budgetDate')");
