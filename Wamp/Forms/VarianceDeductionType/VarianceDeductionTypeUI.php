...
<head>
    ...
    <title>Variance Deduction Type</title>
                                ...
                                <div class="menu-container">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Variance Deduction Type</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="sparkline8-list shadow-reset">
                                ...
                                <div class="sparkline8-graph">
                                    <form id="varianceDeductionForm" name="varianceDeductionForm" method="post" autocomplete="off" action="">
                                        <div class="container">
                                            <div class="form-group">
                                                <label for="deductionDescription">Deduction Description</label>
                                                <input type="text" class="form-control" id="deductionDescription" name="deductionDescription" maxlength="50" required>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <table class="table table-bordered">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="text-align:center;">Deduction Description</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            <?php
                                            $queryA = "SELECT * FROM `variancedeductiontype` ORDER BY `ID` ASC";
                                            ...
                                            if (!empty($resultA)) {
                                                foreach ($resultA as $r) {
                                                    ...
                                                    <tr id="show">
                                                        ...
                                                        <td style="text-align:left;" id="DeductionDescription-<?php echo $ID; ?>"><?php echo $r['DeductionDescription']; ?></td>
...
<script type="text/javascript">
    $(function() {
        $("#addDeduction").click(function() {
            ...
            var dataString = 'deductionDescription=' + deductionDescription;

            if (deductionDescription == '') {
                $(".alertWarning").fadeIn(100).html(' <span class="closebtn" onclick="this.parentElement.style.display=\'none\';\"></span>Deduction Description is required!');
                $(".alertWarning").fadeIn().delay(2000).fadeOut();
            } else {
                $.ajax({
                    type: "POST",
                    url: "VarianceDeductionTypeProcess.php",
                    data: dataString,
                    cache: false,
                    success: function(html) {
                        $("#deductionList").html(html);
                        $("#varianceDeductionForm")[0].reset();
                        $(".alertSave").fadeIn(100).html(' <span class="closebtn" onclick="this.parentElement.style.display=\'none\';\"></span>Deduction added successfully!');
