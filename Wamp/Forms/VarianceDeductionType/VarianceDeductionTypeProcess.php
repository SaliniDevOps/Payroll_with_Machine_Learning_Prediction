...
if (isset($_POST["deductionDescription"])) {
    $deductionDescription = $_POST["deductionDescription"];

    // Check for duplicate records
    $resultA = $db_handle->runQuery("SELECT * FROM `variancedeductiontype` WHERE `DeductionDescription`='$deductionDescription'");
    if ($resultA instanceof mysqli_result && $resultA->num_rows > 0) {
        ...
        // Insert new record
        $result = $db_handle->insertQuery("INSERT INTO `variancedeductiontype` (`
    ...
    if (!empty($resultA)) {
        ...
        foreach ($resultA as $r) {
            ...
            echo '<tr id="show">
                ...
                <td style="text-align:left;" id="DeductionDescription-' . $ID . '">' . $r['DeductionDescription'] . '</td>
