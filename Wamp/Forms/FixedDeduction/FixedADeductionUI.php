                        ...
                        <div class="col-lg-12">
                            <div class="breadcome-list shadow-reset">
                                <div class="row">
                                    ...
                                    <a href="../FixedDeduction/FixedADeductionUI.php" class="btn btn-primary">Fixed Allowance Management</a>
                                </div>
                                <div class="menu-container">
                                    <a href="../FixedDeductionType/FixedADeductionTypeUI.php" class="btn btn-primary">Fixed Allowance Type</a>
                                </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">Home</a> <span class="bread-slash">/</span></li>
                                            <li><span class="bread-blod">Fixed Deductions</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="sparkline8-list shadow-reset">
                                ...
                                <div class="sparkline8-graph">
                                    <form id="fixedDeductionsForm" name="fixedDeductionsForm" method="post" autocomplete="off" action="">
                                        <div class="container">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="deductionTypeID" name="deductionTypeID">
                                                    ...
                                                    <?php 
                                                    $query = "SELECT * FROM `fixeddeductiontype` ORDER BY ID";
                                                    $result = $db_handle->runQuery($query);
                                                    foreach ($result as $row) {
                                            ...
                                            <div class="form-group">
                                                <button type="button" class="btn btn-primary" id="addFixedDeduction">Add</button>
                                            </div>
                                        </div>
                                            ...
                                            if (!empty($resultA)) {
                                                foreach ($resultA as $r) {
                                                    ...
                                                    <tr id="show">
                                                        ...
                                                        <td style="text-align:left;" id="DeductionTypeID-<?php echo $ID; ?>"><?php echo $r['AllowancesDescription']; ?></td>
    ...
    $(function() {
        $("#addFixedDeduction").click(function() {
            ...
            if (employeeID == '' || deductionTypeID == '' || amount == '') {
                ...
                $.ajax({
                    type: "POST",
                    url: "FixedDeductionsProcess.php",
                    data: dataString,
                    cache: false,
                    success: function(html) {
                        $("#fixedDeductionsList").html(html);
                        $("#fixedDeductionsForm")[0].reset();
