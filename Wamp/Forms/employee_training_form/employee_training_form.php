...
$employeesQuery = "SELECT * FROM employee";
$employeesResult = $db_handle->runQuery($employeesQuery);
?>
...
<head>
    ...
    <title>Employee Training Certificates</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Training Certificates</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="sparkline8-list shadow-reset">
                                ...
                                <div class="sparkline8-graph">
                                    <form id="certificateForm" name="certificateForm" method="post" autocomplete="off" action="">
                                        <div class="container">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="trainingProvider" name="trainingProvider">
                                            </div>
                                            <div class="form-group">
...
<script type="text/javascript">
    $(function() {
        $("#addCertificate").click(function() {
            ...
            var trainingProvider = $("#trainingProvider").val();
            var completionDate = $("#completionDate").val();
            var expirationDate = $("#expirationDate").val();

            var dataString = 'employeeID='+ employeeID + '&trainingName='+ trainingName + '&trainingProvider='+ trainingProvider + '&completionDate='+ completionDate + '&expirationDate='+ expirationDate;

            if(employeeID == '' || trainingName == '' || trainingProvider == '' || completionDate == '' || expirationDate == ''){
                ...
                $.ajax({
                    type: "POST",
                    url: "employee_training_formProcess.php",
                    data: dataString,
                    cache: false,
                    success: function(html){
                        $("#certificateList").html(html);
                        $("#certificateForm")[0].reset();
                        $(".alertSave").fadeIn(100).html(' <span class="closebtn" onclick="this.parentElement.style.display=\'none\';\"></span>Certificate added successfully!');
