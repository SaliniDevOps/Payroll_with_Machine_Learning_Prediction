                                    ...
                                    <div class="col-lg-6">
                                        <div class="breadcome-heading">
											...
											<div class="form-group" style="text-align: left; display: block;"><br>
												<button type="button" class="calculateAttendance btn btn-primary" id="calculateAttendance"> Run Payroll</button>
											</div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                            ...
                            <div class="sparkline8-list shadow-reset">
                                <div class="sparkline8-hd" style="background-color:#f2f2f2;">
                                    <div class="main-sparkline8-hd">
                                        <h1>Attendance Calculations Details </h1>
											...
											<table class="table table-bordered" >
												...
												<?php
												  ...
												  $queryA = "SELECT `rowdatamonthend`.`OT`,`rowdatamonthend`.`Late`,`rowdatamonthend`.`WorkinDay`,`rowdatamonthend`.`WorkingHours`,
															`employee`.`FirstName`,`employee`.`EmployeeCode`,`departments`.`Departments`,`rowdatamonthend`.`ID`
												...
												if(!empty($resultA)){
													foreach ($resultA as $r) {
														...
														<tr id="show">
															...
															<td style ="text-align:left;" id="Departments-<?php echo $ID; ?>"><?php echo $r['FirstName']; ?></td>
