...
<head>
    ...
    <title>Variance Allowances</title>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                            ...
                                            <div class="menu-container">
												<a href="../VarianceAllowances/VarianceAllowances.php" class="btn btn-primary">Variance Allowance Management</a>
											</div>
											<div class="menu-container">
												<a href="../VarianceAllowanceType/VarianceAllowanceTypeUI.php" class="btn btn-primary">Variance Allowance Type</a>
											</div>
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Variance Allowances</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="sparkline8-list shadow-reset">
                                ...
                                <div class="sparkline8-graph">
                                    <form id="varianceAllowancesForm" name="varianceAllowancesForm" method="post" autocomplete="off" action="">
                                        <div class="container">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="allowancesTypeID" name="allowancesTypeID">
                                                    ...
                                                    <?php 
                                                    $query = "SELECT * FROM `varianceallowancetype` ORDER BY ID";
                                                    $result = $db_handle->runQuery($query);
                                                    foreach ($result as $row) {
                                            ...
                                            <div class="form-group">
                                                <button type="button" class="btn btn-primary" id="addVarianceAllowance">Add</button>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    $(function() {
        $("#addVarianceAllowance").click(function() {
            ...
            if (employeeID == '' || allowancesTypeID == '' || amount == '') {
                ...
                $.ajax({
                    type: "POST",
                    url: "VarianceAllowancesProcess.php",
                    data: dataString,
                    cache: false,
                    success: function(html) {
                        $("#varianceAllowancesList").html(html);
                        $("#varianceAllowancesForm")[0].reset();
